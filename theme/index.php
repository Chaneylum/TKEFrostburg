...
//declare what page for nav logic
$page = 'index';
//include nav now that page is set
include 'inc/nav.php';
?>
    <header id="first">
        <div class="header-content">
            <div class="inner">
                <h1 class="cursive">Together we will elevate your health to enrich these parts of your life</h1>
